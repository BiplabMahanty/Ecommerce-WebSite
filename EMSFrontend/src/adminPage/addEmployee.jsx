...
export default function AddEmployeePage() {
  ...
  console.log("Admin Token in AddEmployeePage:", token);  
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
         ...
         <select
           ...
           onChange={(e) => setFormData({ ...formData, department: e.target.value })}  // Correctly update formData.department
         >
           {departments.map((def) => (
             <option key={def} value={def}>{def}</option>  // Use def as key and value since it's a string
           ))}
         </select>
